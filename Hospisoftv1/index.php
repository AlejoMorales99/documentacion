            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  " href="#"><i class="bi bi-info-lg">Acerca de</i> </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link  " href="#"><i class="bi bi-person-lines-fill">  Contacto</i></a>
                        </li>
            ...
            <div class="col-md-4">
                ...
                <div class="card"">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, magnam?</p>
